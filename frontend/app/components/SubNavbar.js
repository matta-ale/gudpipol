...
const SubNavbar = ({ sloganVisible }) => {
  ...
  return (
    <nav
      className={`bg-white h-12 hidden md:flex items-center justify-center px-5 border-b-2 border-b-custom-green fixed w-full z-20 transition-all duration-500 ease-in-out ${
